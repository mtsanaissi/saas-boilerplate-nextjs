const messages = {
  ...
  settings: {
    ...
    themeSubtitle: "Choose how the app looks on this device.",
    themeLabel: "Theme",
    themeHelp: "Saved to this browser and applied immediately.",
    themeLight: "Light",
    themeDark: "Dark",
    themeSystem: "System (match device)",
    save: "Save changes",
